...
function MiddlePlans() {
  ...
  const handleSubmit = async (e) => {
    ...
    formBody.append('formType', 'middle-plans');
  ...
  const plans = [
    ...
    {
      title: 'СІМЕЙНЕ НАВЧАННЯ 5-9 класи',
      old_price_month: '',
      price_month: 'від 499',
      old_price_year: '',
      price_year: 'від 4990',
      features: [
        'Письмові та усні завдання з перевіркою від учителів',
        'Письмовий чат і консультації онлайн з учителями',
        'Звʼязок із класним керівником',
        'Інтерактивні платформи для вивчення іноземних мов (оплачуються додатково)',
        'Звіт про успішність',
        'Додатково можна отримати довідку про те, що дитина навчається дистанційно та виписку навчальних результатів',
        'Дистанційне проведення ДПА',
    ...
    {
      title: 'УКРАЇНОЗНАВЧИЙ КОМПОНЕНТ 5-9 класи',
      old_price_month: '',
      price_month: '1200',
      old_price_year: '',
      price_year: '12000',
      features: [
        'Навчання для дітей з будь якого куточку світу',
        'Державний документ про освіту',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 md:mb-16">
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600 mb-4">
              Вартість навчання 2026-2027 навчальний рік
            </h3>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 text-sm md:text-base">
              Детальну інформацію уточнюйте при оформленні заявки.
            </p>
          </div>
        </div>
      </section>
