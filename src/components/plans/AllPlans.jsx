  ...
  const plans = [
    {
      ...
      price_year: "30000",
      features: ["Онлайн-заняття у реальному часі", "Записи уроків", "Міні-класи до 15 учнів", "Стандарти НУШ", "STEM-освіта", ],
    ...
    },
    {
      ...
      old_price_year: "",
      price_year: "34000",
      features: ["Онлайн-заняття у реальному часі", "Записи уроків", "Міні-класи до 15 учнів", "Індивідуальні консультації", "Профорієнтація", "Розвиток особистості", "Навчання", "Стандарти НУШ", "Підготовка до ДПА"],
    ...
    },
    {
      ...
      old_price_year: "",
      price_year: "40000",
      features: ["Онлайн-заняття у реальному часі", "Записи уроків", "Міні-класи до 15 учнів", "Профорієнтація", "Підготовка до НМТ", "Підготовка до вступу", "Індивідуальні консультації", "Університетська підготовка"],
