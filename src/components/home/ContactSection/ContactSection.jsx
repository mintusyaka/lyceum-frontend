            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <a href="tel:+380980230330" className="text-gray-700 hover:underline">
                    +38 (098) 023-03-30
                  </a>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <a
                    href="mailto:ckdo.proactivity@gmail.com"
                    className="text-gray-700 hover:underline"
                  >
                    ckdo.proactivity@gmail.com
                  </a>
                </div>
