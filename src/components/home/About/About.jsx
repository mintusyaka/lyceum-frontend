        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
                  Вітаємо тебе у просторі, де знання зустрічаються з активністю, а навчання стає справжньою пригодою! Ми — <strong>ліцей компетентної та демократичної освіти «Проактивність»</strong>, і ми створили цей заклад, щоб допомогти кожному учню розкрити свої таланти, розвинути лідерські якості та стати рушієм позитивних змін у світі.
                </p>
          </div>
